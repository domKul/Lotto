...
class ResultAnnouncerFacadeTest {
    ...
    public void it_should_return_response_with_lose_message_if_ticket_is_not_winning_ticket() {
        ...
        String hash = "123";
        ResultAnnouncerFacade resultAnnouncerFacade = new ResultAnnouncerBeanConfiguration().createForTest(resultCheckerFacade, responseRepository, Clock.systemUTC());
    ...
    public void it_should_return_response_with_wait_message_if_date_is_before_announcement_time() {
        ...
        ResultAnnouncerFacade resultAnnouncerFacade = new ResultAnnouncerBeanConfiguration().createForTest(resultCheckerFacade, responseRepository, clock);
        ResultDto resultDto = ResultDto.builder()
                .hash("123")
                .numbers(Set.of(1, 2, 3, 4, 5, 6))
                .hitNumbers(Set.of(1, 2, 3, 4, 9, 0))
