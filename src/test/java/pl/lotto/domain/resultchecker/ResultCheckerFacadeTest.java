...
class ResultCheckerFacadeTest {
    ...
    public void it_should_generate_all_players_with_correct_message() {
        ...
        ResultCheckerFacade resultCheckerFacade = new ResultCheckerBeanConfiguration().createForTest(winningNumbersGeneratorFacade, numberReceiverFacade, playerRepository);
        //when
